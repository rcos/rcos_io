...
def project_enrollments(project, semester):
    if semester and project:
        return project.enrollments.filter(semester=semester).order_by("-is_project_lead")
    return []
...
def to_short_repository(repository_url: str):
    return repository_url.removeprefix("https://github.com/").removeprefix("https://www.github.com/")
