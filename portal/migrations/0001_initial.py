    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "summary",
                    models.CharField(
                        help_text="A one-line summary of the project", max_length=200
                    ),
                ),
                (
                    "description_markdown",
                ...
                ("discord_text_id", models.CharField(blank=True, max_length=200)),
                ("discord_voice_id", models.CharField(blank=True, max_length=200)),
            ],
            options={
                "ordering": ["name"],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "repository_url",
                    models.URLField(help_text="URL of GitHub repository"),
                ),
                (
                    "project",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "presentation_url",
                    models.URLField(help_text="Link to the actual presentation"),
                ),
                (
                    "grade",
                    models.DecimalField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="projects", to="portal.projecttag"
            ),
        ),
        migrations.CreateModel(
